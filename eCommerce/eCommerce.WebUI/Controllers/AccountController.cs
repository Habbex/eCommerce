        ...
        public ActionResult Login(Customer customer)
        {
            if (customer.UserName !=null)
            {
                if (customer.Password != null)
                {
                    ...
                    {
                        var usr = customers.GetAll().Where(a => a.UserName.Equals(customer.UserName) && a.Password.Equals(customer.Password)).FirstOrDefault();
                        if (usr !=null)
                        {
                            Session["CustomerId"] = usr.CustomerId.ToString();
